...
Easiest yet: every badge gets a unique ID generated by the plug-in based on the badge's filename and the directory. Simply use that (you'll have to inspect the source to see what the id is; by example the ID generated by my Site-Licence badge is "badge-damn-licencing-licencing").
